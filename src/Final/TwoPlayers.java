...
Score f1 = new Score(0);
    ...
    private double slopeX = 0.5, slopeY = 0.5, speed = 2;
...
///////// the movement
    ...
    public void winner(GL gl) {
        ...
        if (f1.getScore() >= 7) {
            ...
            playMusic(filepath);
            pla.clip.start();
            JOptionPane.showMessageDialog(null, " Good Job " + name1 + " :O" + name2 +" is Noob");
            ...
            playMusic(filepath);
            pla.clip.start();
            JOptionPane.showMessageDialog(null, " Good Job " + name2 + " :O "+ name1 +" is Noob ");
